...
export const APIKEY_PROVIDERS = {
  ...
  "digitalocean": { id: "digitalocean", alias: "do", name: "DigitalOcean AI", icon: "water_drop", color: "#0080FF", textIcon: "DO", website: "https://cloud.digitalocean.com/model-studio", notice: { text: "DigitalOcean Serverless Inference — OpenAI-compatible endpoint. Use a Model Access Key from the DigitalOcean control panel.", apiKeyUrl: "https://cloud.digitalocean.com/model-studio/serverless-inference" }, serviceKinds: ["llm"], passthroughModels: true, thinkingConfig: THINKING_CONFIG.extended, modelsFetcher: { url: "https://inference.do-ai.run/v1/models", type: "openai" } },
  bluesminds: { id: "bluesminds", alias: "bm", name: "BluesMinds", icon: "hub", color: "#3B6FE0", textIcon: "BM", website: "https://api.bluesminds.com", notice: { text: "Unified OpenAI-compatible API with access to hundreds of models. Free plan includes 500 pi credits on signup.", apiKeyUrl: "https://api.bluesminds.com/console" }, serviceKinds: ["llm"], passthroughModels: true, modelsFetcher: { url: "https://api.bluesminds.com/v1/models", type: "openai" } },
  ...
  bluesminds: { id: "bluesminds", alias: "bluesminds", name: "BluesMinds", icon: "bolt", color: "#3B82F6", textIcon: "BM", website: "https://api.bluesminds.com", notice: { text: "Free tier: daily free pi credits. 200+ models (GPT-4o, Claude Sonnet 4.5, Gemini 2.5 Flash, DeepSeek V4, Kimi K2) free + VIP models via pi credits.", apiKeyUrl: "https://api.bluesminds.com/console/token" }, serviceKinds: ["llm"] },
  ...
  kimchi: { id: "kimchi", alias: "kimchi", name: "Kimchi", icon: "restaurant", color: "#FF6B35", textIcon: "KM", website: "https://kimchi.dev", notice: { text: "Free tier — no rate limits. Anthropic-compatible API with access to Kimi K2.6, MiniMax M2.7, Nemotron 3, and more open-source models.", apiKeyUrl: "https://app.kimchi.dev/serverless" }, passthroughModels: true, serviceKinds: ["llm"], thinkingConfig: THINKING_CONFIG.extended },
  freemodel: { id: "freemodel", alias: "freemodel", name: "FreeModel (GPT)", icon: "auto_awesome", color: "#8B5CF6", textIcon: "FM", website: "https://freemodel.dev", notice: { text: "$300 free credits on signup. OpenAI-compatible endpoint for GPT models via api.freemodel.dev.", apiKeyUrl: "https://freemodel.dev/dashboard" }, passthroughModels: true, serviceKinds: ["llm"], thinkingConfig: THINKING_CONFIG.extended },
  "freemodel-cc": { id: "freemodel-cc", alias: "freemodel-cc", name: "FreeModel (Claude)", icon: "smart_toy", color: "#7C3AED", textIcon: "FC", website: "https://freemodel.dev", notice: { text: "$300 free credits on signup. Anthropic-compatible endpoint for Claude models via cc.freemodel.dev.", apiKeyUrl: "https://freemodel.dev/dashboard" }, passthroughModels: true, serviceKinds: ["llm"], thinkingConfig: THINKING_CONFIG.extended },
